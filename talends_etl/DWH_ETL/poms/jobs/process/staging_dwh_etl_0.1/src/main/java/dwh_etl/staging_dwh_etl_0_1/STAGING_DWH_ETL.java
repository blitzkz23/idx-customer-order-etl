...
package dwh_etl.staging_dwh_etl_0_1;
...
/**
 * Job: STAGING_DWH_ETL Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class STAGING_DWH_ETL implements TalendJob {
	...
	private final String jobName = "STAGING_DWH_ETL";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					STAGING_DWH_ETL.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(STAGING_DWH_ETL.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DWH_ETL_STAGING_DWH_ETL = new byte[0];
		static byte[] commonByteArray_DWH_ETL_STAGING_DWH_ETL = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DWH_ETL_STAGING_DWH_ETL.length) {
					if (length < 1024 && commonByteArray_DWH_ETL_STAGING_DWH_ETL.length == 0) {
						commonByteArray_DWH_ETL_STAGING_DWH_ETL = new byte[1024];
					} else {
						commonByteArray_DWH_ETL_STAGING_DWH_ETL = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DWH_ETL_STAGING_DWH_ETL, 0, length);
				strReturn = new String(commonByteArray_DWH_ETL_STAGING_DWH_ETL, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DWH_ETL_STAGING_DWH_ETL, 0, length);
				strReturn = new String(commonByteArray_DWH_ETL_STAGING_DWH_ETL, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DWH_ETL_STAGING_DWH_ETL) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:HalUniBVL3E98oJ+nZQv1gZ3sNhli+kBoUiu5t8FQN6cMJvrEjR+AQ==");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:omlmbThIZQqMmYZJtZBXCTm5c4/VxQcaqZUeeECrdGwVmu2gH1ScNQ==");
				...
				String dbquery_tDBInput_1 = "SELECT product_id, product_name, product_category, product_unit_price FROM product;\n";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.ProductUnitPrice = null;
						} else {

							row1.ProductUnitPrice = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.ProductUnitPrice = null;
							}
						}
						...
						pstmt_tDBOutput_1.setInt(1, row1.ProductID);

						if (row1.ProductName == null) {
							pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(2, row1.ProductName);
						}

						if (row1.ProductCategory == null) {
							pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(3, row1.ProductCategory);
						}

						if (row1.ProductUnitPrice == null) {
							pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
						} else {
							pstmt_tDBOutput_1.setInt(4, row1.ProductUnitPrice);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:TdmvoWvPN8JI8RHTeF0XdlHCP/V4QFC4hogKShPTBMXR1uSApWNsiw==");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "DimStatusOrder";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "DimStatusOrder";
				}
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jgMv3u2bw4REqy+v2mMYu5MlZF6pPDUylj3afjIUj8UDkRyEh53/7Q==");
				...
				String dbquery_tDBInput_2 = "SELECT * FROM status_order";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row2.StatusId = rs_tDBInput_2.getInt(1);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_2 < 2) {
							row2.StatusOrder = null;
						} else {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.StatusOrder = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.StatusOrder = tmpContent_tDBInput_2;
								}
							} else {
								row2.StatusOrder = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.StatusOrderDesc = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.StatusOrderDesc = tmpContent_tDBInput_2;
								}
							} else {
								row2.StatusOrderDesc = null;
							}
						...
						pstmt_tDBOutput_2.setInt(1, row2.StatusId);

						if (row2.StatusOrder == null) {
							pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(2, row2.StatusOrder);
						}

						if (row2.StatusOrderDesc == null) {
							pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(3, row2.StatusOrderDesc);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:FJt7PycOPhZcFJy/kHuNBPorCk7jG1imHouFMcKLAH2wdiy+gZ9jiQ==");
				...
				if (dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
					tableName_tDBOutput_3 = "DimCustomer";
				} else {
					tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "].[" + "DimCustomer";
				}
...
// ###############################
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Xxds+8xPp4SdonMpC72VHMA2684VBoM4QdUqHYrFhkKlLGZm1i57JQ==");
				...
				String dbquery_tDBInput_3 = "SELECT * FROM customer";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row3.customer_id = rs_tDBInput_3.getInt(1);
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3.contains(
									...
									row3.first_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row3.first_name = tmpContent_tDBInput_3;
								}
							} else {
								row3.first_name = null;
							}
						...
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3.contains(
									...
									row3.last_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row3.last_name = tmpContent_tDBInput_3;
								}
							} else {
								row3.last_name = null;
							}
						...
						if (colQtyInRs_tDBInput_3 < 7) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3.contains(
									...
									row3.no_hp = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row3.no_hp = tmpContent_tDBInput_3;
								}
							} else {
								row3.no_hp = null;
							}
...
// # Output table : 'output'
							output_tmp.CustomerID = row3.customer_id;
							output_tmp.CustomerName = StringHandling.UPCASE(row3.first_name + " " + row3.last_name);
							output_tmp.Age = row3.age;
							output_tmp.Gender = row3.gender;
							output_tmp.City = row3.city;
							output_tmp.NoHP = row3.no_hp;
							output = output_tmp;
// ###############################
...
// Start of branch "output"
						if (output != null) {
							...
							if (output.CustomerID == null) {
								...
								pstmt_tDBOutput_3.setInt(1, output.CustomerID);
							}

							if (output.CustomerName == null) {
								pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(2, output.CustomerName);
							}

							if (output.Age == null) {
								pstmt_tDBOutput_3.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(3, output.Age);
							}

							if (output.Gender == null) {
								pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(4, output.Gender);
							}

							if (output.City == null) {
								pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(5, output.City);
							}

							if (output.NoHP == null) {
								pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(6, output.NoHP);
							}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:1DSFLFgqXdBtAQ/1lOnGrk0+H63TF72Z7c7MqQnLbGsa3X0mo62DIw==");
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Oa97aeRCaXFJICch9E4RICH5uTN5Z36RgtfVD2iZ04m908OWSDfgrA==");
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							row4.OrderID = rs_tDBInput_4.getInt(1);
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							row4.CustomerID = rs_tDBInput_4.getInt(2);
							if (rs_tDBInput_4.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_4 < 3) {
							...
							row4.ProductID = rs_tDBInput_4.getInt(3);
							if (rs_tDBInput_4.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (colQtyInRs_tDBInput_4 < 6) {
							...
							row4.StatusID = rs_tDBInput_4.getInt(6);
							if (rs_tDBInput_4.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_4 < 7) {
							...
							row4.OrderDate = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 7);
						...
						pstmt_tDBOutput_4.setInt(4, row4.Quantity);

						pstmt_tDBOutput_4.setInt(5, row4.Amount);

						pstmt_tDBOutput_4.setInt(6, row4.StatusID);
	...
	public static void main(String[] args) {
		final STAGING_DWH_ETL STAGING_DWH_ETLClass = new STAGING_DWH_ETL();

		int exitCode = STAGING_DWH_ETLClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = STAGING_DWH_ETL.class.getClassLoader()
					.getResourceAsStream("dwh_etl/staging_dwh_etl_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = STAGING_DWH_ETL.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : STAGING_DWH_ETL");
		}
